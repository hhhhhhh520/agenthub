...
> 创建时间: 2026-05-23 | 状态: 🟡部分解决 | 最后更新: 2026-06-06
...
| ISSUE-ORC-002 | 纠偏范围（批量执行已全平台，单 Agent 调用缺失） | route.ts:747-773 | **高** | 🟢已解决 |
...
| ISSUE-FAIL-006 | 用户操作面板（重做已实现，跳过/手动修复不实施） | 第 463-472 行 | **高** | 🟢已解决 |
...
| ISSUE-TOOL-002 | Orchestrator 工具推荐 UI 缺失 | 第 277 行 | 中 | 🟢已解决 |
...
| ISSUE-UI-001 | 会话列表无 Agent 头像拼图 | 第 303 行 | 低 | 🟢已解决 (2026-06-05) |
