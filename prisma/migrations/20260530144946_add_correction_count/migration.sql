...
INSERT INTO "new_Task" ("assignedAgentId", "cliSessionId", "createdAt", "declaredFiles", "dependencies", "description", "id", "sessionId", "status", "updatedAt", "workspacePath") SELECT "assignedAgentId", "cliSessionId", "createdAt", "declaredFiles", "dependencies", "description", "id", "sessionId", "status", "updatedAt", "workspacePath" FROM "Task";
DROP TABLE "Task";
