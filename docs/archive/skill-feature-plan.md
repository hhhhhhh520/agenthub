...
- **multica** (`D:\projects\multica`) — Skill 表 + SkillFile + AgentSkill 关联，URL 导入 + 本地扫描，写到 provider-native 发现路径
- **cc-connect** (`D:\projects\cc-connect`) — SkillRegistry 递归扫描 SKILL.md，skill-presets.json 远程预设
